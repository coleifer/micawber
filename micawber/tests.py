...
class ProviderTestCase(BaseTestCase):
    ...
    def test_bootstrap_basic_matching(self):
        ...
        urls = [
            ...
            'https://music.apple.com/us/album/1440935467',
            'https://bsky.app/profile/bsky.app/post/3mu3jzet72s2k',
            ...
            'https://www.youtube.com/playlist?list=PLbpi6ZahtOH71mwANLzAlPX9cZafnzIqt',
        ]
        for url in urls:
